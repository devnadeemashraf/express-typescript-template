/*
  ...
  - You are about to drop the `app_logs` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `http_logs` table. If the table is not empty, all the data it contains will be lost.
